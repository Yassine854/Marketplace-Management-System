...
export default function BannerDataTable({
  ...
  const columns = useMemo<ColumnDef<Banner, any>[]>(
    () => [
      columnHelper.accessor("url", {
        ...
        cell: (info) => (
          <div className="flex justify-center">
            <img
              src={info.getValue()}
              alt={info.row.original.altText || "Banner image"}
    ...
    return (
      <div className="flex h-48 items-center justify-center rounded-lg border border-red-200 bg-red-50">
        <div className="text-center">
          <p className="font-medium text-red-800">Error loading banners</p>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative max-w-sm flex-1">
          <input
            ...
            value={
              (table.getColumn("altText")?.getFilterValue() as string) ?? ""
            }
            onChange={(event) =>
              table.getColumn("altText")?.setFilterValue(event.target.value)
            }
          ...
          {(table.getColumn("altText")?.getFilterValue() as string) && (
            <button
              onClick={() => table.getColumn("altText")?.setFilterValue("")}
