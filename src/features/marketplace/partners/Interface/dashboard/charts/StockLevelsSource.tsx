...
const StockLevelsSource = () => {
  ...
  useEffect(() => {
    ...
    const chartId = "e239f3d4-4064-4030-afc8-572930ef6b60";

    const filter = {
      "skuPartnerId_lookup_sku_partners.partnerId": { $oid: partnerId },
    };
...
export default StockLevelsSource;
