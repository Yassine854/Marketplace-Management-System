...
const columnHelper = createColumnHelper<VendorOrder>();
...
export default function OrderDataTable({
  ...
  const allSelectedAreOpen =
    ...
    selectedOrderIds.every((id) => {
      ...
      return order?.status?.name?.toLowerCase() === "open";
    });
      ...
      columnHelper.accessor("order", {
        ...
        cell: (info) => (
          <span className="text-sm font-medium text-gray-900">
            {info.getValue()?.customer?.firstName || "-"}{" "}
      ...
      columnHelper.accessor("order", {
        ...
        cell: (info) => (
          <span className="text-sm text-gray-900">
            {info.getValue()?.customer?.telephone || "-"}
          </span>
        ),
        size: 100,
      }),
  ...
  return (
    <div className="w-full space-y-3">
      ...
      {allSelectedAreOpen && (
        <div className="mb-2 flex items-center gap-3 rounded border border-blue-200 bg-blue-50 p-3">
          ...
          >
            ...
            <option value="valid">Set Status to Valid</option>
            <option value="canceled">Set Status to Cancel</option>
          </select>
          <button
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative max-w-sm flex-1">
          ...
          {(table.getColumn("customer")?.getFilterValue() as string) && (
            <button
              onClick={() => table.getColumn("customer")?.setFilterValue("")}
