  ...
  const columns = useMemo<ColumnDef<Product, any>[]>(
    () => [
      ...
      columnHelper.accessor(
        (row) => {
          const skuPartner = row.skuPartners?.find(
            (sp) => sp.partnerId === partnerId && sp.productId === row.id,
          );
          return skuPartner?.skuPartner || "-";
        },
        {
          id: "skuPartner",
          header: "SKU",
      ...
      columnHelper.accessor((row) => row.supplier?.companyName || "-", {
        id: "supplier",
        header: "Supplier",
        cell: (info) => (
          <span className="text-sm text-gray-900">{info.getValue()}</span>
      ...
      columnHelper.accessor("accepted", {
        ...
        cell: (info) => (
          ...
          >
            ...
            ></span>
            {info.getValue() ? "Accepted" : "Pending"}
          </span>
        ),
        size: 100,
      }),
