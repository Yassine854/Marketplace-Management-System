...
const Profile = ({ partnerData }: ProfileProps) => {
  ...
  return (
    <div className="h-full w-full">
      <div className="grid h-full grid-cols-1 gap-4 lg:grid-cols-12 xxxl:gap-6">
        ...
        <div className="lg:col-span-7 xl:col-span-8">
          <div className="box p-3">
            <div className="box bg-primary/5 dark:bg-bg3 xxxl:p-8">
              ...
              {/* Personal Details */}
              <div className="box mb-4 border-none lg:mb-6 xxl:p-4">
                <div className="bb-dashed mb-4 flex items-center justify-between pb-2 md:mb-4 md:pb-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {details.map(({ title, value }) => (
                    <div key={title} className="col-span-1">
                      ...
                      <p className="max-w-full truncate text-base font-medium md:text-lg">
                        {value}
                      </p>
                    </div>
                  ))}
              ...
              <div className="box border-none xxl:p-4">
                <div className="bb-dashed mb-4 flex items-center justify-between pb-2 md:mb-4 md:pb-4">
