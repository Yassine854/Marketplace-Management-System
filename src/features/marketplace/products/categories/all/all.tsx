...
const CategoryList = () => {
  ...
  const filteredData = categories.filter((item) => {
    const name = item.nameCategory?.toLowerCase() ?? "";
  ...
  const handleEdit = (id: string) => {
    // Directly push to the edit page
    router.push(`/marketplace/products/categories/edit/${id}`);
  };
  ...
  const handleCreate = async () => {
    router.push("/marketplace/products/categories/new");
  };
    ...
    <div className="mt-12 w-full px-3 py-6 duration-300 sm:px-4 lg:py-8 xxxl:px-6">
      ...
      <div className="box">
        <div className="bb-dashed mb-6 flex flex-wrap items-center justify-between gap-3 pb-6">
          <p className="font-medium">Category List View</p>
            ...
            <thead>
              <tr className="bg-primary/5 font-semibold dark:bg-bg3">
                ...
                <td className="p-5">
                  <div
                    className="flex cursor-pointer select-none items-center gap-1"
                    onClick={() => handleSort("nameCategory")}
                  >
                    Category Name
                    {/* Sort arrow */}
                  </div>
            ...
            <tbody>
              {loading ? (
                ...
                currentItems.map((category) => (
                  ...
                  >
                    <td className="px-3 py-2 pl-6">{category.id}</td>
