...
const columnHelper = createColumnHelper<ProductStatus>();
...
export default function ProductStatusTable({
  ...
  const columns = useMemo<ColumnDef<ProductStatus, any>[]>(
    () => [
      ...
      <div className="flex h-48 items-center justify-center rounded-lg border border-red-200 bg-red-50">
        <div className="text-center">
          <p className="font-medium text-red-800">
            Error loading product statuses
          </p>
                ...
                <tr>
                  ...
                  >
                    <div className="text-gray-500">
                      ...
                      <p className="font-medium">No product statuses found</p>
