...
const columnHelper = createColumnHelper<TypePcb>();
...
export default function TypePcbTable({
  ...
  const columns = useMemo<ColumnDef<TypePcb, any>[]>(
    () => [
    ...
    return (
      <div className="flex h-48 items-center justify-center rounded-lg border border-red-200 bg-red-50">
        <div className="text-center">
          <p className="font-medium text-red-800">Error loading PCB types</p>
                ...
                <tr>
                  ...
                  >
                    <div className="text-gray-500">
                      ...
                      <p className="font-medium">No PCB types found</p>
