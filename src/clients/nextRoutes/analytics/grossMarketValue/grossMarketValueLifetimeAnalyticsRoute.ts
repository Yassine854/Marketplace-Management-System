import { grossMarketValueLifetimeAnalytics } from "@/services/analytics/grossMarketValue/grossMarketValueLifetimeAnalytics";
import { responses } from "../../responses";
import { logError } from "@/utils/logError";
import { NextResponse, type NextRequest } from "next/server";

export const grossMarketValueLifetimeAnalyticsRoute = async (
  request: NextRequest,
) => {
  try {
    ...
    const res = await grossMarketValueLifetimeAnalytics(startYear, endYear);
