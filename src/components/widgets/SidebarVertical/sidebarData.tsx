...
export const sidebarData = [
  {
    ...
    items: [
      ...
      },
      {
        id: 2,
        name: "Finance",
        icon: <IconCoins className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 3,
        name: "Banking",
        icon: <IconBuildingBank className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 4,
        name: "Business",
        icon: <IconBriefcase className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 6,
        name: "Apps",
        icon: <IconDeviceMobilePlus className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 8,
        name: "Widgets",
        icon: <IconApps className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
    ...
    items: [
      {
        id: 101,
        name: "Lists",
        icon: <IconList className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 102,
        name: "Flex Lists",
        icon: <IconLayoutList className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 103,
        name: "Table Lists",
        icon: <IconBorderAll className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 104,
        name: "Form Layouts",
        icon: <IconNotes className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 105,
        name: "Placeloads",
        icon: <IconHourglassEmpty className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 106,
        name: "Card Grids",
        icon: <IconLayoutGrid className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 107,
        name: "Tile Grids",
        icon: <IconGridGoldenratio className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 108,
        name: "User Grids",
        icon: <IconGrid4x4 className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 109,
        name: "Projects",
        icon: <IconReportAnalytics className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 110,
        name: "Authenticaion",
        icon: <IconUserShield className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 111,
        name: "Subpages",
        icon: <IconFileImport className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 112,
        name: "Utility",
        icon: <IconSettingsBolt className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
      ...
      },
      {
        id: 113,
        name: "Onboarding",
        icon: <IconHeartHandshake className="h-5 w-5 lg:h-6 lg:w-6" />,
        submenus: [
