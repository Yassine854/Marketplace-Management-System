...
const Hero = ({ onSearch, status }: any) => {
  ...
  return (
    <div className="flex  flex-col rounded-2xl bg-n30  ">
      <div className=" w-full  p-2">
        <p className="m-2 mb-4 text-2xl font-bold">{status} Orders </p>
      </div>

      <div className=" flex flex-col justify-between p-4 xl:flex-row">
        ...
        <div className="flex  h-full flex-col ">
          <form>
            <div className=" flex  flex-grow  flex-col justify-between xl:flex-row">
