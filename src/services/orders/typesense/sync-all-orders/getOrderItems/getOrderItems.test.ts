...
import { getOrderItems } from "./index"; // Adjust the path as needed

describe("getOrderItems", () => {
  test("converts order items correctly", () => {
    //  expect(getOrderItems(orderItems)).toEqual(expectedOrderItems);
  });

  test("returns an empty array when orderItems is undefined", () => {
    expect(getOrderItems(undefined)).toEqual([]);
  });
...
// const expectedOrderItems: OrderLine[] = [
//   {
//     id: "1",
//     orderId: "100",
//     kamiounOrderId: "",
